...
class InternalServerErrorError extends base_1.HttpError {
    constructor(message, properties) {
...
InternalServerErrorError.status = 500;
InternalServerErrorError.error = 'InternalServerError';
InternalServerErrorError.message = 'Internal Server Error';
InternalServerErrorError.phrase = 'Internal server error.';
