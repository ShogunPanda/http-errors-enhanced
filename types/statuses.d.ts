export declare const identifierByCodes: {
    [key: string]: string;
};
export declare const codesByIdentifier: {
    [key: string]: number;
};
export declare const messagesByCodes: {
    [key: string]: string;
};
export declare const phrasesByCodes: {
    [key: string]: string;
};
...
export declare const URITOO_LONG = 414;
...
export declare const IMA_TEAPOT = 418;
...
export declare const TOO_EARLY = 425;
...
export declare const HTTPVERSION_NOT_SUPPORTED = 505;
export declare const VARIANT_ALSO_NEGOTIATES = 506;
export declare const INSUFFICIENT_STORAGE = 507;
export declare const LOOP_DETECTED = 508;
export declare const BANDWIDTH_LIMIT_EXCEEDED = 509;
